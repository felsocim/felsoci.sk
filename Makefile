publish: tangle
	guix time-machine -C .guix/channels.scm -- shell --pure -m .guix/manifest.scm -- emacs --batch --no-init-file --eval '(setq org-confirm-babel-evaluate nil)' --load publish.el --funcall org-publish-all
